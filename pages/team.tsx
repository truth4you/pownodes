  ...
  return (
    <div className="flex flex-col">
      <div className={classNames(styles.welcome, "pt-10 md:pt-20 md:flex")}>
        ...
        <div className="m-10 hidden md:block"><Image className="" src="/basic.png" width={143} height={143} /></div>
      </div>
      ...
      <div className={classNames(styles.blogs, "md:flex flex-wrap justify-between gap-10 md:pt-10")}>
        <div className="flex-1">
          ...
          <p className="flex justify-center">
            <Image className={classNames(styles.teamMember)} src="/team/team1.png" width={350} height={350} />
          </p>
        </div>
