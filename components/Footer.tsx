...
export default function Footer() {
  return (
    ...
    //         <li>
    //           <Link href="https://docs.pownodes.finance/" passHref>
    //             <a target="_blank">Whitepaper</a>
    //           </Link>
    //         </li>

    //         <li>
    //           <Link href="https://twitter.com/pownodes" passHref>
    ...
    //       <p className="mt-10">
    //         &copy; 2022 PowNodes.finance. All Rights Reserved.
    //       </p>
    ...
    //           you should not treat any of the website's content as such. PowNodes.finance will not accept liability for any loss or damage, including without
